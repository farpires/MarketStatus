...
function sellCurrencyForDollar(currencyPair, type, amount){
    const ws = require("ws");
      ...
      w.on("message", (msg) => {
        ...
        if (!flag) {
          ...
          for (const bidPrice of bidsPrices) {
            ...
            let coinAmount = bidAmount*bid;
            let result = bidAmount-accumulatedAmount;
  ...
  function buyCurrencyForDollar(currencyPair, type, amount){
    const ws = require("ws");
    const w = new ws(BITFINEX_WEBSOCKET);
      ...
      w.on("message", (msg) => {
        ...
        if (!flag) {
          ...
          for (const askPrice of asksPrices) {
            ...
            let coinAmount = askAmount*ask;
            let result = askAmount-accumulatedAmount;
  ...
  module.exports = {
    buyCurrencyForDollar,
    sellCurrencyForDollar
  };